...
export const ModalEditQuestion = (props) => {
    ...
    const handleSubmit = async () => {
        ...
        let isUpdate = true;
        newQuestionData['update_at'] = new Date();
        newQuestionData['update_id'] = 1;
        ...
        for(let i = 0; i < 4 ;i++) {
            ...
            newAnswerData['update_at'] = new Date();
            newAnswerData['update_id'] = 1;
