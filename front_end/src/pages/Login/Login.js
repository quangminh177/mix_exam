                ...
                <div className="container-form-login">
                    ...
                    <form action="#">
                        ...
                        <label>
                            ...
                            {(eye === false) ? 
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"   className="w-5 h-5" onClick={handleChange}>
                        ...
                        <button style={{backgroundColor: "orange"}} onClick={(e) => handleSubmit(e)}>Sign In</button>
                    </form>
                </div>
